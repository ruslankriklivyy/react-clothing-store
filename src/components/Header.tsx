...
const Header = React.memo(function Header() {
  ...
  const { totalPrice, visibleCart } = useSelector(
  ...
  return (
    <>
      <BlockOut
        ref={blockOutRef}
        show={
          visibleCart || visibleAuthBlock || visibleBurgerMenu || visibleLogout
            ? "show"
            : ""
        }
      ></BlockOut>
      <HeaderMain name={chosenProduct && chosenProduct.name}>
        ...
        <Auth
          ...
          setVisibleAuthBlock={setVisibleAuthBlock}
        />
        <HeaderWrapper>
          <Logo>
            <Link to="/">
          ...
          <HeaderRight>
            ...
            <div>
              <ShoppingBlockImage
                onClick={() => dispatch(setVisibleCart(true))}
              >
            ...
            <BurgerMenuButton
              onClick={() => setVisibleBurgerMenu(!visibleBurgerMenu)}
            >
